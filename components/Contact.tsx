...
import { Mail, MapPin, Send, Loader2, CheckCircle2 } from "lucide-react"; // Tambah icon Loader & Check
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hasanamirul77@gmail.com" className="text-lg font-black text-brand-text hover:text-brand-purple transition-colors">
                    hasanamirul77@gmail.com
                  </a>
                </div>
              </div>

      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight text-brand-text">
            Amirul <span className="text-brand-blue">Hasan</span>.
          </h1>
          ...
          <div className="flex gap-5 items-center text-brand-text/60">
            <a href="https://github.com/amirulhasan" target="_blank" rel="noopener noreferrer" className="hover:text-brand-purple transition-colors" title="GitHub">
            ...
            <a href="https://instagram.com/amirulhasan" target="_blank" rel="noopener noreferrer" className="hover:text-brand-pink transition-colors" title="Instagram">
            ...
            <a href="https://linkedin.com/in/amirulhasan" target="_blank" rel="noopener noreferrer" className="hover:text-brand-blue transition-colors" title="LinkedIn">
        ...
        >
          ...
          >
            ...
            >
              <img 
                src="/images/hero%201%20%26%202.jpeg" 
                alt="Amirul Hasan" 
              ...
              <div className="absolute top-10 left-10 text-white">
                <h3 className="text-3xl font-black tracking-tight">Amirul <span className="text-brand-amber">Hasan</span></h3>
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between text-white p-4 bg-white/10 rounded-full shadow-lg backdrop-blur-md border border-white/10">
                <div className="flex items-center gap-3">
                  <img 
                    src="/images/hero%201%20%26%202.jpeg" 
                    alt="Foto Profil amirulhasan" 
                    className="w-10 h-10 rounded-full border border-white/20 object-cover object-top"
                  />
                  <div>
                    <p className="text-base font-black text-white/90">@amirulhasan</p> 
